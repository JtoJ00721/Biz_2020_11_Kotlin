...
// 속성 name, age에 접근 가능하다
// 단
// name val로 선언되어서 읽기 전용이다.
//      obj : Class_03 = Class_02()
//      var n = obj.name 가능
//      obj.name = "농농이"
//      var a = obj.age 가능
//      obj.age = 30 가능
...
//      var obj = Class_03("빙빙이", 20) : name 속성과 age를 정의
//      var obj = Class_03() : name은 농농이, age는 17로 초기화 한다
class Class_03(val name : String = "농농이", var age : Int = 17)
